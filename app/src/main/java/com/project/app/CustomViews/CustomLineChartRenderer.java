...
public class CustomLineChartRenderer extends LineRadarRenderer {
   ...
   public  boolean hideFirstAndLast=true;

    public boolean isHideFirstAndLast() {
        return hideFirstAndLast;
    }
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            mCirclePaintInner.setColor(dataSet.getCircleHoleColor().get(0));
            ...
            boolean drawTransparentCircleHole = drawCircleHole &&
                    dataSet.getCircleHoleColor().get(0) == ColorTemplate.COLOR_NONE;
           ...
           DataSetImageCache imageCache;
            ...
            for (int j = mXBounds.min; j <= boundsRangeCount; j++) {
                ...
                if(hideFirstAndLast)  if(j==0 || j==boundsRangeCount)continue;
    ...
    private class DataSetImageCache {
        ...
        protected void fill(ILineDataSet set, boolean drawCircleHole, boolean drawTransparentCircleHole) {
            ...
            for (int i = 0; i < colorCount; i++) {
                ...
                mCirclePaintInner.setColor(set.getCircleHoleColor().get(i));
