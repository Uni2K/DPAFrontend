...
public class ViewPortHandler {
    ...
    public void restrainViewPort(float offsetLeft, float offsetTop, float offsetRight,
        ...
        Log.d("restrainViewPort","DATA: "+offsetBottom+"  "+offsetLeft+"  "+offsetRight+"  "+offsetTop+"      DT: "+offsetBottom()+"  "+offsetLeft()+"   "+offsetRight()+"   "+offsetTop());
        float mMinOffset = 15.f;
        float minOffset = Utils.convertDpToPixel(mMinOffset);

        mContentRect.set(offsetLeft, offsetTop+minOffset, mChartWidth - offsetRight, mChartHeight
                - minOffset);
    }
